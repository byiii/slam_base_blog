...
void axisAngleToRotationMatrix(const double *axis, double angle, Eigen::Matrix3f &mat, bool normalized_p=true);
...
void quaternionToEulerAngle(const Eigen::Quaternionf &q, Eigen::Vector3f &eulerAngles);

void rotationMatrixToEulerAngle_viaQuaternion(const Eigen::Matrix3f &mat, Eigen::Vector3f &eulerAngles);

void eulerAnglesToRotationMatrix(const Eigen::Vector3f &eulerAngles, Eigen::Matrix3f &mat);
